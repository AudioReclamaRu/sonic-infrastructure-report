...
CONFLICT_MAP = {
    'voice-scams-trust': 'attack',
    'rynok-dve-storony': 'split',
    'umg-elevenlabs': 'right',
    'edison-verdict': 'trust',
    'fitoussi-human-preference': 'provenance',
    'kto-proveril-golos': 'attention',
    'golos-banka': 'interface',
    'vybor-diktora': 'choice',
    'ozvuchka-video': 'deficit',
    'umg-infrastruktura': 'infrastructure',
    'golos-pult': 'interface',
    'pravovoy-sloy-golosa': 'right',
    'radio-ne-umret': 'power',
    'slepoj-test-golosa': 'trust',
    'aktery-protiv-klonov': 'attack',
    'open-source-golos': 'provenance',
    'open-letter-otchet-2026': 'attention',
    'open-letter-bankam-2026': 'interface',
    'open-letter-telecom-2026': 'attention',
    'open-letter-riteylu-2026': 'power',
    'open-letter-aviazcii-2026': 'trust',
    'open-letter-media-2026': 'provenance',
    'open-letter-edtech-2026': 'deficit',
    'open-letter-muzeyam-2026': 'choice',
    'open-letter-promu-2026': 'infrastructure',
    'open-letter-igram-2026': 'split',
    'open-letter-medicine-2026': 'trust',
    'open-letter-sobytiyam-2026': 'right',
}
