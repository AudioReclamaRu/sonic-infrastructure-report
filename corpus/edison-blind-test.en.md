...
1. Blind test by Edison Research (with SSRS): 1000+ listeners, May 2026.
   **61% of listeners took a synthetic voice for a live narrator.**
...
Recording stopped being a scarcity and a price argument: if six out of ten
listeners can't tell synthesis from live performance, "it was recorded by a
live narrator" no longer justifies a budget. What the recording does not contain
...
If Edison refutes the test data (61%, readiness, purchase) after the webinar,
this document is corrected publicly with the date and reason. A number does not
get a retrofitted story.
